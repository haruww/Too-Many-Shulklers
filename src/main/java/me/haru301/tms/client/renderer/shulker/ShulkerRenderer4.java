...
@OnlyIn(Dist.CLIENT)
public class ShulkerRenderer4 extends MobRenderer<AbstractCustomShulkerEntity, ShulkerModel<AbstractCustomShulkerEntity>>
{
    public static final ResourceLocation SHULKER_TEXTURE = new ResourceLocation(TooManyShulkers.MOD_ID, "textures/entity/shulker/poison_shulker.png");

    public ShulkerRenderer4(EntityRendererManager renderManagerIn)
    {
