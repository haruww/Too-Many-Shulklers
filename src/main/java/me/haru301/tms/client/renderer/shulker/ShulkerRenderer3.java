...
@OnlyIn(Dist.CLIENT)
public class ShulkerRenderer3 extends MobRenderer<AbstractCustomShulkerEntity, ShulkerModel<AbstractCustomShulkerEntity>>
{
    public static final ResourceLocation SHULKER_TEXTURE = new ResourceLocation(TooManyShulkers.MOD_ID, "textures/entity/shulker/firecharge_shulker.png");

    public ShulkerRenderer3(EntityRendererManager renderManagerIn)
    {
